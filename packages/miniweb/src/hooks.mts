...
/**
  ...
  This file implements the internal hooks engine of MiniWeb, providing all structures, types and functions for manage components hooks instance (including `useState` and `useEffect`).
