import { LeafElement } from "./elements.mjs";
export {};     // Ensure this file is treated as a module




/**  JSX.MTS Type Definitions for leaf-js

  This file tells TypeScript how to handle TSX/JSX syntax within the leaf-js framework.
  It's NOT executed at runtime, it only serves to help the TypeScript compiler understand:
    ...
    - What type the JSX syntax is compiled into (LeafElement)
  This is what makes it possible to use leaf-js just like React, but with full type safety.
...
declare global {
  ...
  namespace JSX {
    ...
    // Specifies the return type of JSX elements. In leaf-js, any JSX element (<div>, <Component />, etc.) becomes a LeafElement.
